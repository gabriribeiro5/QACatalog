...
output = output.withColumn("arrangenmentdescription", F.when(output["arrangementstatus"] == "1", "PROMESSA")\
                    .when(output["arrangementstatus"] == "2", "PAGANDO")\
                    .when(output["arrangementstatus"] == "3", "PAGO")\
                    .when(output["arrangementstatus"] == "4", "QUEBRADO"))  

output = output.select("identitynumber", "arrangementid", "arrangementdate", "arrangementamount", "arrangementstatus", "arrangenmentdescription", \
    "delinquencydays", "portfoliogroup", "totalinstallments", "paidinstallments", "agency", "firstintallmentamount", \
    "installmentamount", "expirationdate", "portfolio", "productname", "referencebalance", "postalcode", "phonearea", \
    "phonenumber", "lastmodificationdate", "processingdate", "sourcedirection", "sourcename")
