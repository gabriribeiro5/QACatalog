#=============================================================================#
#                                                                             #
# Objetivo : Script PySpark que ingere os dado baseado do SQL SERVER.         #
...
#------------------------------- Descrição -----------------------------------#
#                                                                             #
#  Do catálogo, extrai o schema e escreve na raw zone.                        #
#                                                                             #
#------------------------------- Parâmetros ----------------------------------#
#                                                                             #
...
args = getResolvedOptions(sys.argv, ['JOB_NAME', 'CRAWLER_TABLE', 'S3_TARGET', 'CRAWLER_DATABASE'])
...
for column  in ingestion.columns :
    if column == "dataversion":
        ingestion = ingestion.withColumn(column, col(column).cast("string"))
    else:
        pass
