...
output = output.withColumn("phonetypedescription", 
                    F.when(output["phonetype"] == "1", "CELULAR_PESSOAL")\
                    .when(output["phonetype"] == "2", "CELULAR_COMERCIAL")\
                    .when(output["phonetype"] == "3", "FIXO_PESSOAL")\
                    .when(output["phonetype"] == "4", "FIXO_COMERCIAL")\
                    .when(output["phonetype"] == "5", "REFERENCIA")\
                    .when(output["phonetype"] == "6", "OUTROS"))  

output = output.withColumn("phonecategorydescription", 
                    F.when(output["phonecategory"] == "1", "PREFERENCIAL")\
                    .when(output["phonecategory"] == "2", "NAO_PREFERENCIAL")\
                    .when(output["phonecategory"] == "3", "NAO_INFORMADO"))

output = output.select("identitynumber", "phonearea", "phonenumber", "phonetype", "phonetypedescription", \
    "phonecategory", "phonecategorydescription", "phonestatus", "phoneextension", "notes", "sourcephone", \
