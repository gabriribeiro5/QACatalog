#=============================================================================#
#                                                                             #
# Objetivo: Script principal do validador de arquivos de pessoa coligadas     #
...
from modules.content import cpf_cnpj, date_columns, \
    person_status, sourcedirection, sourcename
...
if (output_df.count() == 0):
    ...
    if len(column_error) == 0:
        ...
        df_ok, df_nok_2 = person_status.validate(columns[1], df_ok)
        df_ok, df_nok_3 = date_columns.validate(columns[2], df_ok)
        df_ok, df_nok_4 = date_columns.validate(columns[3], df_ok)
        df_ok, df_nok_5 = sourcedirection.validate(columns[4], df_ok)
        df_ok, df_nok_6 = sourcename.validate(columns[5],df_ok)
        dfs_nok = [df_nok_1, df_nok_2, df_nok_3, df_nok_4, df_nok_5, df_nok_6]
